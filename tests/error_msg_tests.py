...
import dcp_parser.atomic.atom_loader
...
class TestErrorMsg(object):
      ...
      def test_operations(self):
          ...
          error_str = "Illegal operation: nonconvex + constant"
          assert_equals(str(exp.errors[0]),self.dcp_violation + error_str)

      # Test error messages generated by compositions
      def test_operations(self):
          atom_dict = atomic.atom_loader.generate_atom_dict()
          ...
          assert_equals(str(exp.errors[0]),self.dcp_violation + error_str))
          assert_equals(exp.errors[0].index,1)
          ...
          assert_equals(exp.errors[0].index,2)